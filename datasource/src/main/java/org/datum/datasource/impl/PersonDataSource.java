...
import org.datum.generators.CreditCardGenerator;
import org.datum.generators.EmailGenerator;
import org.datum.generators.LastNameGenerator;
import org.datum.model.Gender;

/**
 * 
 * Used to generate personal data (last name, email, credit card number, gender,
 * etc)
 * 
 * @author akaliutau
 *
...
public class PersonDataSource implements RandomDataSource {
	...
	private static List<Double> prob = Arrays.stream(Gender.values()).map(g -> g.getProbability())
